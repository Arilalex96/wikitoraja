...
<html lang="en">
    <head>
        ...
        <meta name="description" content="WikiToraja - Platform berbagi pengetahuan tentang budaya dan warisan Toraja." />
    ...
    <body>
        ...
        <!-- Footer-->
         <footer class="py-5 bg-dark text-center text-white custom-footer">
